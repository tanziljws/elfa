...
@section('page-description', 'Kelola foto yang Anda upload')
...
<div class="page-header">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="page-title">
                    <i class="fas fa-images me-3"></i>Foto Saya
                </h1>
                <p class="page-subtitle">Kelola foto yang Anda upload</p>
            </div>
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <!-- Tambahkan tombol upload foto jika diizinkan -->
                    @if(\App\Models\Setting::get('enable_user_upload', true) == true)
                        <a href="{{ route('user.galleries.upload') }}" class="btn btn-success">
                            <i class="fas fa-plus me-1"></i>Upload Foto
                        </a>
                    @else
                        <button class="btn btn-success" onclick="showUploadWarning()" disabled>
                            <i class="fas fa-plus me-1"></i>Upload Foto
                        </button>
                    @endif
                </div>
        ...
        <div class="col-12">
            <div class="table-card">
                <div class="p-5 text-center">
                    ...
                    <h5>Anda Belum Mengupload Foto</h5>
                    <p class="text-muted mb-4">Anda belum mengupload foto apa pun ke galeri.</p>
                    <!-- Tambahkan tombol upload foto jika diizinkan -->
                    @if(\App\Models\Setting::get('enable_user_upload', true) == true)
                        <a href="{{ route('user.galleries.upload') }}" class="btn btn-success">
...
// Fungsi untuk menampilkan peringatan upload
function showUploadWarning() {
    alert("Fitur upload foto telah dinonaktifkan oleh admin");
}
</script>
@endsection